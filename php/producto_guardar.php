<?php
	...
	$proveedor=limpiar_cadena($_POST['proveedor_id']);


	/*== Verificando campos obligatorios ==*/
    if($codigo=="" || $nombre=="" || $precio=="" || $stock=="" || $proveedor==""){
        echo '
	...
	if($_FILES['producto_foto']['name']!="" && $_FILES['producto_foto']['size']>0){
		...
		if(mime_content_type($_FILES['producto_foto']['tmp_name'])!="image/jpeg" && mime_content_type($_FILES['producto_foto']['tmp_name'])!="imagen3/png"){
			echo '
	            <div class="notification is-danger is-light">
	                <strong>¡Ocurrio un error inesperado!</strong><br>
    ...
    $guardar_producto=$guardar_producto->prepare("INSERT INTO producto(producto_codigo,producto_nombre,producto_precio,producto_stock,producto_foto,proveedor_id,usuario_id) VALUES(:codigo,:nombre,:precio,:stock,:foto,:proveedor,:usuario)");
